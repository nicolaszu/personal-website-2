...
<script>
import iphoneMask from '~/static/images/trailBee/IphoneMaskLogo.svg?inline'
...
@keyframes float {
  0% {
    transform: translateY(40px) rotate3d(0, 0, 0, 0deg);
  }

  100% {
    transform: translateY(50px) rotate3d(0, 0, 0, 0deg);
  }
}
</style>
